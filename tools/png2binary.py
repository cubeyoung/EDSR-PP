...
parser.add_argument('--pathFrom', default='/data01/kky/KKY/DIV2K/DIV2K_train_LR_EDSR_O',
                    help='directory of images to convert')
parser.add_argument('--pathFrom2', default='/data01/kky/KKY',
                    help='directory of images to convert')
parser.add_argument('--split', default=False,
                    help='save individual images')

args = parser.parse_args()
pathTo = args.pathFrom2 + '_decoded'
