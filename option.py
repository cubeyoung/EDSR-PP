...
parser = argparse.ArgumentParser(description='EDSR-PP')
...
parser.add_argument('--n_GPUs', type=int, default= 1,
                    help='number of GPUs')
parser.add_argument('--n_GPU_number', type=int, default = 0,
                    help='GPUs number')
...
parser.add_argument('--dir_data', type=str, default= '/data01/kky/KKY',   
...
parser.add_argument('--patch_mult',type =float,default =1,
			help = ' just use 8 to 4, 8 to 2, 8 to 1 image scale')
...
parser.add_argument('--model', default='EDSRPP',
                    help='model name')
...
parser.add_argument('--pre_train_1', default = '.',
                    help='2 to 1')
